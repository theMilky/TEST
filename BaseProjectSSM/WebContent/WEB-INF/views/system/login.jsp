...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <title>SSM框架后台管理员登陆</title>
  <meta name="description" content="particles.js is a lightweight JavaScript library for creating particles.">
  <meta name="author" content="Vincent Garreau">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
  <link rel="stylesheet" med ia="screen" href="../resources/admin/login/css/style.css">
		...
		<div class="login" style="display: block;">
			...
			<div class="login-center clearfix">
				...
				<div class="login-center-input">
					...
					<img id="cpacha-img" title="点击切换验证码" style="cursor:pointer;" src="get_cpacha?vl=4&w=120&h=40&type=loginCpacha" width="110px" height="30px" onclick="changeCpacha()">
				</div>
			</div>
...
<script type="text/javascript">
	...
	function changeCpacha() {
		$("#cpacha-img").attr("src", 'get_cpacha?vl=4&w=120&h=40&type=loginCpacha&t=' + new Date().getTime());
	} 
